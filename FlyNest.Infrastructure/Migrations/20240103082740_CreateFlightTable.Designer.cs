...
namespace FlyNest.Infrastructure.Migrations
{
    ...
    [Migration("20240103082740_CreateFlightTable")]
    partial class CreateFlightTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlyNest.SharedKernel.Entities.Flight", b =>
                {
                    ...
                    b.HasOne("FlyNest.SharedKernel.Entities.Stoppies", "Stoppies")
                        .WithMany("Flights")
                        .HasForeignKey("StoppieId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
